          ...
          <AuthenticationContext.Provider value={authentication}>
            ...
            <Router>
              <Routes>
                ...
                <Route path="/signuplocador" element={<Signuplocadorpage />} />
                <Route path="/signuplocatario" element={<Signuplocatariopage />} />
                ...
                <Route path="/empresa/:id/infoquadras" element={<GuardedRoute><LocadorPage /></GuardedRoute>} />
